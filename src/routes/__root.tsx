...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Buildohub — Construction Materials Procurement" },
      {
        name: "description",
        content:
          "Live prices, verified suppliers and tracked deliveries for construction materials across India.",
      },
      { name: "author", content: "Buildohub" },
      { property: "og:title", content: "Buildohub" },
      {
        property: "og:description",
        content: "Procurement for construction materials, made effortless.",
      },
